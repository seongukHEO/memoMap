...
import kr.co.lion.android01.mapmemoproject.Fragment.UserInfoFragment
import kr.co.lion.android01.mapmemoproject.Fragment.UserInfoModifyFragment
import kr.co.lion.android01.mapmemoproject.FragmentNameUserInfo
import kr.co.lion.android01.mapmemoproject.R
import kr.co.lion.android01.mapmemoproject.databinding.ActivityUserInfoBinding
import kr.co.lion.android01.mapmemoproject.databinding.HeadDrawerMenuBinding
...
class UserInfoActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name:FragmentNameUserInfo, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            FragmentNameUserInfo.USER_INFO_FRAGMENT -> {
                newFragment = UserInfoFragment()
            }
            FragmentNameUserInfo.USER_INFO_MODIFY_FRAGMENT -> {
                newFragment = UserInfoModifyFragment()
            }
        }
        ...
        if(newFragment != null){
            ...
            fragmentTransaction.replace(R.id.containerUserInfo, newFragment!!)
    ...
    fun removeFragment(name:FragmentNameUserInfo){
        SystemClock.sleep(200)
    ...
    fun settingNavigationView(){
        activityUserInfoBinding.apply {
            navigationViewUserInfo.apply {
                // 헤더로 보여줄 View를 생성한다.
                val headDrawerMenuBinding = HeadDrawerMenuBinding.inflate(layoutInflater)
                // 헤더로 보여줄 View를 설정한다.
                addHeaderView(headDrawerMenuBinding.root)

                // 사용자 닉네임을 설정한다.
                headDrawerMenuBinding.userName.text = "홍길동"
